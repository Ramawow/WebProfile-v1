...
function preview(element) {
	const clickedImage = element.parentElement.parentElement;
	portfolioContainer.prepend(clickedImage);
	// move the clicked image to the beginning of the portfolio container
}
